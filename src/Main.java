...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdo Inscrito  Barbara:  " + devBarbara.getConteudosInscritos());

        devBarbara.progredir();
        devBarbara.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Barbara:  " + devBarbara.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos  Barbara: " + devBarbara.getConteudoConcluidos());
